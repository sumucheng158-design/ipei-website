      ...
      <section className="relative pt-32 pb-24 bg-ocean-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-ocean-300 text-sm mb-4">
            <Link href="/programs" className="hover:text-white transition-colors">活動項目</Link>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-6 space-y-4 text-gray-600 leading-relaxed text-sm">
                <p>
                  全球每年有超過 <strong className="text-ocean-600">800 萬噸</strong> 的塑膠垃圾進入海洋，
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={s.label} className="text-center p-4 bg-ocean-50 rounded-2xl">
                    <div className="font-display text-2xl font-bold text-ocean-600">{s.value}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 p-6 bg-amber-50 border border-amber-200 rounded-2xl">
            <p className="text-amber-800 text-sm leading-relaxed">
              ⚠️ <strong>重要提醒：</strong> 惡劣天氣（颱風、大浪、雷雨）時活動將取消或延期，
      ...
      <section className="py-20 bg-gradient-to-br from-ocean-800 to-ocean-950">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/get-involved" className="bg-white text-ocean-700 hover:bg-ocean-50 font-semibold px-8 py-4 rounded-full transition-all duration-200 hover:shadow-lg">
              報名淨灘活動
            </Link>
            <Link href="/resources" className="border border-white/30 text-white hover:bg-white/10 font-medium px-8 py-4 rounded-full transition-all duration-200">
              下載活動指南
            </Link>
          </div>
        </div>
